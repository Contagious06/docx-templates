...
var processCmd = function (data, node, ctx) { return __awaiter(void 0, void 0, void 0, function () {
    var cmd, _a, cmdName, cmdRest, aliasMatch, aliasName, fullCmd, result, str, literalXmlDelimiter_1, img, e_1, pars, html, err_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
            ...
            case 7:
                ...
                if (ctx.options.processLineBreaks) {
                    literalXmlDelimiter_1 = ctx.options.literalXmlDelimiter;
                    str = str
                        .split(/[\n\r]+/) // could use different split criteria here
                        .map(function (para) {
                        return literalXmlDelimiter_1 + "</w:t><w:br/>" + literalXmlDelimiter_1 + para + literalXmlDelimiter_1 + "<w:t>" + literalXmlDelimiter_1;
                    })
                        .join('');
                }
                return [2 /*return*/, str];
